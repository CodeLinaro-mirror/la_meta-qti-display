...
DEPENDS += "libhardware linux-msm-headers display-commonsys libcutils displaydlkm-headers"
...
CPPFLAGS += "${@bb.utils.contains_any('BASEMACHINE', 'sun alor', '-DSUPPORT_DPPS', '', d)}"
