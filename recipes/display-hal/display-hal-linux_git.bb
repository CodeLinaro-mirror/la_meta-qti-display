...
CPPFLAGS += "-I${WORKSPACE}/display/vendor/qcom/proprietary/display/color/rgb-histogram/inc"
CPPFLAGS += "-I${WORKSPACE}/display/vendor/qcom/proprietary/display/utils/tinyxml2"
